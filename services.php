...
<body>
    ...
    <div class="services">
        <br>
                ...
                <H2>SERVICES</H2>
                <br>
                <h4>FIELDS OF OPERATION</h4><br>
    <div class="container">
        <h5>Construction both Civil and Structural</h5>
        <div class="image2">
            <p>Ongoing structural project</p>
            <img src="structure2.jpg" alt="">
        </div>
        <div class="image2">
            <p> Completed Project</p>
            <img src="construction4.jpg" alt="">
        </div><br><br><br>
         <div class="image2">
        <p>Electrical Works<p>
            <img src="electrical2.jpg" alt="">
        </div>
         <div class="image2">
            <p>Electrical Works<p>
            <img src="electrical.webp" alt="#">
        </div>
        <div class="image2">
            <p>Painting and Interior<p>
        ...
        <div class="image2">
            ...
            <img src="drill1.jpg" alt="#">
        </div>
        <div class="image2">
            <p>Borehole Drilling<p>
            <img src="drill2.jpg" alt="#">
        </div>
         <div class="image2">
            <p>Water networking and Plumbing<p>
            <img src="plumbing.jpg" alt="#">
        </div>
        <div class="image2">
            <p>Water networking and Plumbing<p>
            <img src="plumbing2.jpg" alt="#">
        </div>
         <!--Electrical installation-->
        <div class="image2">
            <p>Supply and installation of Solar Panel<p>
            <img src="installation.jpg" alt="#">
        </div>
        <div class="image2">
            <p>Supply and installation of Solar Panel<p>
            <img src="installation2.jpg" alt="#">
        </div>
        <!--Structural and architectural designs-->
        <div class="image2">
            <p>Architectural Design<p>
            <img src="plan4.jpeg" alt="#">
        </div>
        <div class="image2">
            <p>Architectural Design<p>
            <img src="plan3.jpeg" alt="#">
        </div>
         <!--fabrication-->
        <div class="image2">
        ...
        <div class="image2">
            <p>Fabrication Works<p>
            <img src="fabrication2.jpg" alt="#">
        </div>
         <!--construction materials-->
        <div class="image2">
            <p>Supply Of Construction Materials<p>
            <img src="materials.jpg" alt="#">
        </div>
        <div class="image2">
            <p>Supply Of Construction Materials<p>
            <img src="materials2.jpg" alt="#">
        </div>
